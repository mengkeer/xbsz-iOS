...
- (UIView *)underLine
{
    ...
    if (_underLine == nil) {
        ...
        underLineView.layer.cornerRadius = _underLineH/2;
...
- (UIScrollView *)titleScrollView
{
    if (_titleScrollView == nil) {
        ...
        titleScrollView.backgroundColor = _titleScrollViewColor?_titleScrollViewColor:[UIColor colorWithWhite:1 alpha:0];
...
- (void)setUpAllTitle
{
    ...
    CGFloat startX =  (YZScreenW-self.childViewControllers.count*_titleWidth )/2;
    ...
    for (int i = 0; i < count; i++) {
        ...
        label.frame = CGRectMake(startX+labelX, labelY, labelW, labelH);
...
//        
//        // 右边颜色
//        rightLabel.textColor = CXBlueColor;
//        
//        // 左边颜色
//        leftLabel.textColor = CXRedColor;
//        return;
//    }
//    
    // 填充渐变
