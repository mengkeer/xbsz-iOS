...
- (UIButton *)avatarBtn{
    if(!_avatarBtn){
        ...
        [_avatarBtn setImage:[[[UIImage imageNamed:@"defaultUserPhoto"] imageByResizeToSize:CGSizeMake(36, 36) contentMode:UIViewContentModeScaleToFill] imageByRoundCornerRadius:18] forState:UIControlStateNormal];
